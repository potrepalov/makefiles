...
putvar = $(call put, $(2)$(strip $(1)) == '$($(strip $(1)))')
# putvar = $(call put, $(2)$(1) == '$($(1))')

# Condition put
cput = $(if $(strip $($(1))),$(call putvar,$(1),$(2)))
...
$(eval $(foreach lang,$(LANGS), \
    $(eval SAVE_$(lang)_EXCLUDE_FILES_$(1)_$(2):=)))
$(eval $(foreach lang,$(LANGS), $(eval $(call cput,$(lang)_EXCLUDE_FILES))))

$(eval EXCULED_FILES := $(SAVE_EXCLUDE_FILES_$(1)_$(2)))
$(eval SAVE_EXCLUDE_FILES_$(1)_$(2):=)
$(eval $(call cput, EXCLUDE_FILES))
endef


# reduce_one  reldir,srcdir
define reduce_one
$(eval $(1) := $(dir $($(1):%/=%)))
$(eval $(2) := $($(2):../%=%))
$(eval $(call reduce_all,$(1),$(2)))
endef
#define reduce_one
#$(eval $(1) := $(dir $(patsubst %/,%,$($(1)))))
#$(eval $(2) := $(patsubst ../%,%,$($(2))))
#$(eval $(call reduce_all,$(1),$(2)))
#endef

# reduce_all  reldir,srcdir
define reduce_all
$(if $(subst 1,,$(patsubst ../%,1,$($(2)))),,           \
	$(if $(patsubst ./%,%,$(strip $($(1)))),        \
		$(eval $(call reduce_one,$(1),$(2)))    \
	)                                               \
)
endef
...
# del_cur name, val
define del_cur
$(if $(findstring //,$(2)),$(call del_cur,$(1),$(subst //,/,$(2))),         \
    $(if $(findstring /./,$(2)), $(call del_cur,$(1),$(subst /./,/,$(2))),  \
        $(eval $(1) := $(2))))
endef
...
$(call putvar,SRCDIR,Before sanity: )
SRCDIR := $(subst \,/,$(SRCDIR))
$(eval $(call del_cur,SRCDIR,$(SRCDIR)/))
SRCDIR := $(SRCDIR:./%=%)
SRCDIR := $(SRCDIR:%/=%)
$(call putvar,SRCDIR,After sanity: )
...
$(call put, Before reduce: RELDIR/SRCDIR == $(RELDIR)$(SRCDIR))
$(call reduce_all,RELDIR,SRCDIR)
$(call put, After reduce: RELDIR/SRCDIR == $(RELDIR)$(SRCDIR))

RELDIR := $(RELDIR)$(SRCDIR)/
...
$(call put, )
$(call put, Restore EXCLUDE_FILES)
